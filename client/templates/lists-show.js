...
Template.listsShow.events({
  ...
  'click .open-local': function (evt) {
    // If desktop, prevent default and have Electron open file
    if (Meteor.isElectron) {
      ...
      if (list) {
        // Get path on local
        var localPath = Desktop.ipc.sendSync('getLocalPath', { listName: list.name });
        // Open in folder
        if (localPath) Desktop.shell.openItem(localPath);
      }
      return false;
    }
  }
